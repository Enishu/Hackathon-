        ...
        <div class="relative p-3 rounded-2xl shadow-lg bg-stone-100 hover:scale-105 transition
            ...
            <div className="absolute -bottom-6 -right-5 flex gap-2">
                <PopUpComment postId={postId}>
                    <div class="relative size-10 cursor-pointer bg-stone-100 shadow-lg ring-1 hover:bg-stone-200 ring-stone-200 rounded-full flex justify-center items-center
