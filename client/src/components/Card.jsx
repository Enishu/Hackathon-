...
export default ({ text, postId}) => {
    return (
        <div class="relative p-3 rounded-2xl shadow-lg bg-indigo-600 hover:scale-105 transition">
            <div className="absolute -top-8 -left-6 flex gap-1">
                <div class="size-12 bg-indigo-700 rounded-full flex justify-center items-center">
            ...
            <div className="absolute -bottom-8 -right-6 flex gap-1">
                <PopUpComment postId={postId}>
                    <div class="size-12 cursor-pointer bg-indigo-700 rounded-full flex justify-center items-center">
