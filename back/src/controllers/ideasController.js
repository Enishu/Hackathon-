...
export const createIdeas = async (req, res) => {
    try {
        ...
        const { text } = req.body; // Correspond au modele (text, userId)
...
export const getIdeasByUser = async (req, res) => {
    try {
        ...
        res.status(500).json({
            success: false,
            message:
                "Erreur serveur lors de la recuperation des idees utilisateur",
        });
    }
};
>>>>>>> e7a291da1380c4cf817ed794aef7e348ed222a20
